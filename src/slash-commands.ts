...
const COMMANDS: SlashCommand[] = [
  ...
  { name: "/jobs", desc: "Manage background jobs", category: "core", availability: "partial", helpText: "Background jobs are managed by the TUI runtime. The GUI does not expose a job queue. Use the TUI for /jobs support." },
  ...
  { name: "/undo", desc: "Undo last action", category: "session", availability: "partial", helpText: "Shows the last turn info. Full undo is not supported via the API. Use /clear or create a new thread." },
  { name: "/retry", desc: "Retry last turn", category: "session", availability: "partial", helpText: "Retry is not directly supported in GUI. Please send your message again." },
  ...
  { name: "/skills", desc: "List skills", category: "skills", availability: "unavailable", helpText: "Not available: Skill system requires TUI's runtime environment for install/activate/execute." },
  { name: "/skill", desc: "Run a skill", category: "skills", availability: "unavailable", helpText: "Not available: Skill execution requires TUI's runtime environment." },
  ...
  { name: "/sessions", desc: "Manage sessions", category: "session", availability: "partial", helpText: "Use the sidebar thread list to manage sessions." },
  { name: "/load", desc: "Load a session", category: "session", availability: "partial", helpText: "Use the sidebar thread list to load sessions." },
